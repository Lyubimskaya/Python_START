...
if x == 0 and y == 0:
    ...
    print('Точка на положительной оси абсцисс')
elif x < 0 and y == 0:
    print('Точка на отрицательной оси абсцисс')
elif x == 0 and y > 0:
    print('Точка на положительной оси ординат') 
elif x == 0 and y < 0:
    print('Точка на отрицательной оси ординат') 
